					...
					<div class="col-lg-4 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								...
								<li><i class="ti-email"></i> autorich@shophub.com</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="#"><img src="{{asset('/')}}images/logo.png" width="25%" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							...
							<div class="contact">
								<ul>
									<li>NO. 342 - Padang Moh Yamin Street.</li>
									<li>012 Indonesia.</li>
									<li>info@eshop.com</li>
									<li>+628 5334 5678 90</li>
								</ul>
							</div>
							<!-- End Single Widget -->
							<ul>
			...
			<div class="container">
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © 2020 <a href="http://furgetech.com" target="_blank">furgetech</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
